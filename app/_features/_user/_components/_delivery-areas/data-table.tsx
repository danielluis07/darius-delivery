...
type DeliveryAreasDataTableProps<TData, TValue> = {
...
export function DeliveryAreasDataTable<TData, TValue>({
  columns,
  data,
  onDelete,
  isLoading,
  searchKey,
}: DeliveryAreasDataTableProps<TData, TValue>) {
        ...
        <div
          onClick={async () => {
            const ok = await confirm({
              title: "Tem certeza?",
              message: "Você está prestes a deletar as áreas selecionadas",
            });
