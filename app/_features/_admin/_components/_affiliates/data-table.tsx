...
type AffiliatesDataTableProps<TData, TValue> = {
...
export function AffiliatesDataTable<TData, TValue>({
  columns,
  data,
  onDelete,
  isLoading,
  searchKey,
}: AffiliatesDataTableProps<TData, TValue>) {
        ...
        <div
          onClick={async () => {
            const ok = await confirm({
              title: "Deletar os afiliados",
              message:
                "Você tem certeza que deseja deletar esses afiliados? Essa ação é irreversível.",
            });
